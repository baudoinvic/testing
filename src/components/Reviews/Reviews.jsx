  ...
  const fallbackReviews = [
    {
      ...
      rating: 5,
      image: coffee,
      text: "The cappuccino here is top-notch, and the ambiance is perfect for remote work. Highly recommend!"
    },
    {
      id: 2,
      user_name: "Ella J.",
      ...
      rating: 5,
      image: ecobank,
      text: "I had an issue with my bank account, and the staff was incredibly patient and helpful. A bit of a wait, but worth it!"
    },
    {
      id: 3,
      user_name: "Rick S.",
      ...
      rating: 5,
      image: gym,
      text: "Good equipment, but it gets too packed in the evenings. Morning sessions are better."
    }
  ];
  ...
  const renderReview = (review, isFromApi) => {
    if (isFromApi) {
      ...
      return (
        <div key={review.id} className="bg-blue-50 rounded-lg p-6 shadow-sm">
          <div className="flex items-center mb-4">
            <img src={review.avatar} alt={review.user_name} className="w-10 h-10 rounded-full mr-3" />
